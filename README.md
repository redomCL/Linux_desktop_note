...
`
  ...
  * 7.最后的可逆：卸载Wine：`sudo apt remove winehq-staging`，移除WineHQ仓库：`sudo rm /etc/apt/sources.list.d/winehq.list`，删除 GPG 密钥：`sudo rm /etc/apt/keyrings/winehq-archive.key`。
  * 8.随着wine和linux更新，最终部署步骤应以官网为准：https://www.winehq.org/
